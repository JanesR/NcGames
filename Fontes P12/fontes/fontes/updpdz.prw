...
ฑฑบ Programa ณ UPDPDZ   บ Autor ณ TOTVS Protheus     บ Data ณ  04/03/2013 บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
ฑฑบ Descricaoณ Funcao de update dos dicionแrios para compatibiliza็ใo     ณฑฑ
ฑฑบ          ณ                                                            บฑฑ
ฑฑฬออออออออออุออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออนฑฑ 
ฑฑณ Uso      ณ UPDPDZ     - Gerado por EXPORDIC / Upd. V.4.10.6 EFS       ณฑฑ
ฑฑศออออออออออฯออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออผฑฑ
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿
*/
User Function UPDPDZ( cEmpAmb, cFilAmb )
...
If lOk
	...
	If !Empty( aMarcadas )
		...
		If lAuto
			If lOk
				MsgStop( "Atualiza็ใo Realizada.", "UPDPDZ" )
				dbCloseAll()
			Else
				MsgStop( "Atualiza็ใo nใo Realizada.", "UPDPDZ" )
				dbCloseAll()
			EndIf
		Else
			If lOk
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑษออออออออออัออออออออออหอออออออัออออออออออออออออออออหออออออัอออออออออออออปฑฑ
ฑฑบ Programa ณ FSTProc  บ Autor ณ TOTVS Protheus     บ Data ณ  04/03/2013 บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑษออออออออออัออออออออออหอออออออัออออออออออออออออออออหออออออัอออออออออออออปฑฑ
ฑฑบ Programa ณ FSAtuSX2 บ Autor ณ TOTVS Protheus     บ Data ณ  04/03/2013 บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
...
aAdd( aSX2, { ;
	'PDZ'																	, ; //X2_CHAVE
	cPath																	, ; //X2_PATH
	'PDZ'+cEmpr																, ; //X2_ARQUIVO
	'Grupo de Tributa็ใo'													, ; //X2_NOME
	'Grupo de Tributacion'													, ; //X2_NOMESPA
	'Taxation Group'														, ; //X2_NOMEENG
	0																		, ; //X2_DELET
	'E'																		, ; //X2_MODO
	''																		, ; //X2_TTS
	''																		, ; //X2_ROTINA
	'S'																		, ; //X2_PYME
	'DZ_FILIAL+DZ_GRTRIB+DZ_SEQUEN+DTOS(DZ_DTVALID)'						, ; //X2_UNICO
	'E'																		, ; //X2_MODOEMP
	'E'																		, ; //X2_MODOUN
	9																		} ) //X2_MODULO
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑษออออออออออัออออออออออหอออออออัออออออออออออออออออออหออออออัอออออออออออออปฑฑ
ฑฑบ Programa ณ FSAtuSX3 บ Autor ณ TOTVS Protheus     บ Data ณ  04/03/2013 บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
...
aAdd( aSX3, { ;
	...
	6																		, ; //X3_TAMANHO
	0																		, ; //X3_DECIMAL
	'Grupo Trib.'															, ; //X3_TITULO
	'Grupo Trib.'															, ; //X3_TITSPA
	'Tax. Group'															, ; //X3_TITENG
	'Grupo de Tributacao'													, ; //X3_DESCRIC
	'Grupo de Tributacion'													, ; //X3_DESCSPA
	'Taxation Group'														, ; //X3_DESCENG
	'@!'																	, ; //X3_PICTURE
	'ExistCpo("SX5","21"+M->DZ_GRTRIB)'										, ; //X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(176)					, ; //X3_USADO
	''																		, ; //X3_RELACAO
...
aAdd( aSX3, { ;
	...
	'Secuencia'																, ; //X3_TITSPA
	'Sequence'																, ; //X3_TITENG
	'Sequencia de Tributacao'												, ; //X3_DESCRIC
	'Secuencia de Tributacion'												, ; //X3_DESCSPA
	'Taxation Sequence'														, ; //X3_DESCENG
	'@!'																	, ; //X3_PICTURE
	''																		, ; //X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	'Destination State'														, ; //X3_DESCENG
	'@!'																	, ; //X3_PICTURE
	'M->DZ_EST$"**" .OR. ExistCpo("SX5","12"+M->DZ_EST)'					, ; //X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(160)					, ; //X3_USADO
	''																		, ; //X3_RELACAO
...
aAdd( aSX3, { ;
	...
	'Tipo'																	, ; //X3_TITSPA
	'Type'																	, ; //X3_TITENG
	'Tipo do Cliente / Fornec.'												, ; //X3_DESCRIC
	'Tipo de Cliente / Proveed'												, ; //X3_DESCSPA
	'Type of Cust./Suppl.'													, ; //X3_DESCENG
	'@!'																	, ; //X3_PICTURE
	'Pertence("FLRSX*")'													, ; //X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	...
	''																		, ; //X3_OBRIGAT
	''																		, ; //X3_VLDUSER
	'*=Todos;F=Cons.Final;L=Prod.Rural;R=Revend.;S=Solidario;X=Importacao'		, ; //X3_CBOX
	'*=Todos;F=Cons.Final;L=Prod.Rural;R=Revend.;S=Solidario;X=Importacion'		, ; //X3_CBOXSPA
	'*=All;F=Final Cons.;L=Rural Prod.;R=Reseller;S=Solidario;X=Import'		, ; //X3_CBOXENG
	''																		, ; //X3_PICTVAR
	''																		, ; //X3_WHEN
	''																		, ; //X3_INIBRW
	''																		, ; //X3_GRPSXG
...
aAdd( aSX3, { ;
	...
	5																		, ; //X3_TAMANHO
	2																		, ; //X3_DECIMAL
	'Aliq.Interna'															, ; //X3_TITULO
	'Alic.Interna'															, ; //X3_TITSPA
	'InternalRate'															, ; //X3_TITENG
	'Aliquota de ICMS interna'												, ; //X3_DESCRIC
	'Alicuota de ICMS interna'												, ; //X3_DESCSPA
	'Internal ICMS rate'													, ; //X3_DESCENG
	'@E 99.99'																, ; //X3_PICTURE
	''																		, ; //X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	5																		, ; //X3_TAMANHO
	2																		, ; //X3_DECIMAL
	'Aliq.Externa'															, ; //X3_TITULO
	'Alic.Externa'															, ; //X3_TITSPA
	'ExternalRate'															, ; //X3_TITENG
	'Aliquota de ICMS externa'												, ; //X3_DESCRIC
	'Alicuota de ICMS externa'												, ; //X3_DESCSPA
	'External ICMS rate'													, ; //X3_DESCENG
	'@E 99.99'																, ; //X3_PICTURE
	''																		, ; //X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	6																		, ; //X3_TAMANHO
	2																		, ; //X3_DECIMAL
	'Margem Lucro'															, ; //X3_TITULO
	'Margen Ganan'															, ; //X3_TITSPA
	'Prof. Margin'															, ; //X3_TITENG
	'Margem de Lucro Presumida'												, ; //X3_DESCRIC
	'Margen Ganancia Estimada'												, ; //X3_DESCSPA
	'Presumed Profit Margin'												, ; //X3_DESCENG
	'@E 999.99'																, ; //X3_PICTURE
	''																		, ; //X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	5																		, ; //X3_TAMANHO
	2																		, ; //X3_DECIMAL
	'Al.ICMS Dest'															, ; //X3_TITULO
	'Al.ICMS Dest'															, ; //X3_TITSPA
	'Dest ICMS Rt'															, ; //X3_TITENG
	'Aliquota ICMS no Destino'												, ; //X3_DESCRIC
	'Alicuota ICMS en Destino'												, ; //X3_DESCSPA
	'Destination ICMS Rate'													, ; //X3_DESCENG
	'@E 99.99'																, ; //X3_PICTURE
	''																		, ; //X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	3																		, ; //X3_TAMANHO
	0																		, ; //X3_DECIMAL
	'Grp.Cli./For'															, ; //X3_TITULO
	'Grp.Cli./Pro'															, ; //X3_TITSPA
	'Grp Cust/Sup'															, ; //X3_TITENG
	'Grupo de Clientes/Fornec.'												, ; //X3_DESCRIC
	'Grupo de Clientes/Proveed'												, ; //X3_DESCSPA
	'Group of Custom/Supplier'												, ; //X3_DESCENG
	'@!'																	, ; //X3_PICTURE
	''																		, ; //X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	...
	''																		, ; //X3_OBRIGAT
	''																		, ; //X3_VLDUSER
	'CFI=C.Fin.c/ IE;CFS=C.Fin.s/ IE;SOL=Solidario;ZFM=Z.Franca;ALC=Ar.Liv.Com;LIM=Liminar;REV=Revendedor;ALS=ALC/Solidario', ; //X3_CBOX
	'CFI=C.Fin.c/ IE;CFS=C.Fin.s/ IE;SOL=Solidario;ZFM=Z.Franca;ALC=Ar.Liv.Com;LIM=Liminar;REV=Revendedor;ALS=ALC/Solidario', ; //X3_CBOXSPA
	'CFI=C.Fin.c/ IE;CFS=C.Fin.s/ IE;SOL=Solidario;ZFM=Z.Franca;ALC=Ar.Liv.Com;AMO=Am.Ocid;LIM=Liminar;REV=Revendedor', ; //X3_CBOXENG
	''																		, ; //X3_PICTVAR
	''																		, ; //X3_WHEN
	''																		, ; //X3_INIBRW
	''																		, ; //X3_GRPSXG
...
aAdd( aSX3, { ;
	...
	'ISS'																	, ; //X3_TITSPA
	'ISS'																	, ; //X3_TITENG
	'Excecao referente a ISS ?'												, ; //X3_DESCRIC
	'ฟExcepcion referente ISS?'												, ; //X3_DESCSPA
	'Exception refer. to ISS'												, ; //X3_DESCENG
	'@!'																	, ; //X3_PICTURE
...
aAdd( aSX3, { ;
	...
	9																		, ; //X3_TAMANHO
	2																		, ; //X3_DECIMAL
	'ICMS Pauta'															, ; //X3_TITULO
	'ICMS Pauta'															, ; //X3_TITSPA
	'ICMS'																	, ; //X3_TITENG
	'Valor do ICMS de Pauta'												, ; //X3_DESCRIC
	'Valor del ICMS de Pauta'												, ; //X3_DESCSPA
...
aAdd( aSX3, { ;
	...
	'IPI Pauta'																, ; //X3_TITULO
	'IPI Pauta'																, ; //X3_TITSPA
	'Settled IPI'															, ; //X3_TITENG
	'Valor do IPI de Pauta'													, ; //X3_DESCRIC
	'Valor del IPI de Pauta'												, ; //X3_DESCSPA
	'Settled IPI Value'														, ; //X3_DESCENG
	'@e 999,999.99'															, ; //X3_PICTURE
	''																		, ; //X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	'PIS Pauta'																, ; //X3_TITULO
	'PIS Pauta'																, ; //X3_TITSPA
	'Agenda PIS'															, ; //X3_TITENG
	'Valor do PIS de Pauta'													, ; //X3_DESCRIC
	'Valor PIS de Pauta'													, ; //X3_DESCSPA
	'Agenda PIS Value'														, ; //X3_DESCENG
...
aAdd( aSX3, { ;
	...
	11																		, ; //X3_TAMANHO
	4																		, ; //X3_DECIMAL
	'COFINS Pauta'															, ; //X3_TITULO
	'COFINS Pauta'															, ; //X3_TITSPA
	'Ag. COFINS'															, ; //X3_TITENG
	'Valor do COFINS de Pauta'												, ; //X3_DESCRIC
	'Valor de COFINS de Pauta'												, ; //X3_DESCSPA
	'Agenda COFINS Value'													, ; //X3_DESCENG
	'@E 999,999.9999'														, ; //X3_PICTURE
	'Positivo()'															, ; //X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	12																		, ; //X3_TAMANHO
	2																		, ; //X3_DECIMAL
	'ICMSPautaPro'															, ; //X3_TITULO
	'ICMSPautaPro'															, ; //X3_TITSPA
	'Set.ICMS Pro'															, ; //X3_TITENG
	'ICMS PautaProprio Excecao'												, ; //X3_DESCRIC
	'ICMS PautaPropio Excepc.'												, ; //X3_DESCSPA
	'Settled ICMS Prop Except.'												, ; //X3_DESCENG
...
aAdd( aSX3, { ;
	...
	'Alic.PIS'																, ; //X3_TITSPA
	'PIS rate'																, ; //X3_TITENG
	'Alํquota de PIS'														, ; //X3_DESCRIC
	'Alํcuota de PIS'														, ; //X3_DESCSPA
	'PIS rate'																, ; //X3_DESCENG
	'@E 99.99'																, ; //X3_PICTURE
	''																		, ; //X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	'Alic.Cof.'																, ; //X3_TITSPA
	'COF rate'																, ; //X3_TITENG
	'Aliquota de Cofins'													, ; //X3_DESCRIC
	'Alicuota de Cofins'													, ; //X3_DESCSPA
	'COFINS rate'															, ; //X3_DESCENG
	'@E 99.99'																, ; //X3_PICTURE
	''																		, ; //X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	2																		, ; //X3_DECIMAL
	'Base ICMS'																, ; //X3_TITULO
	'%Red.del IC'															, ; //X3_TITSPA
	'ICMS Red.%'															, ; //X3_TITENG
	'Base do ICMS'															, ; //X3_DESCRIC
	'%Red.del ICMS'															, ; //X3_DESCSPA
	'ICMS Red.%'															, ; //X3_DESCENG
	'@E 99.99'																, ; //X3_PICTURE
	'Positivo()'															, ; //X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	2																		, ; //X3_DECIMAL
	'Base IPI'																, ; //X3_TITULO
	'%Red.del IPI'															, ; //X3_TITSPA
	'IPI Red.%'																, ; //X3_TITENG
	'Base do IPI'															, ; //X3_DESCRIC
	'%Red.del IPI'															, ; //X3_DESCSPA
	'IPI Red.%'																, ; //X3_DESCENG
	'@E 99.99'																, ; //X3_PICTURE
	'Positivo()'															, ; //X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	'Red.PIS'																, ; //X3_TITSPA
	'PIS red.'																, ; //X3_TITENG
	'Redu็ใo de PIS'														, ; //X3_DESCRIC
	'Reduccion de PIS'														, ; //X3_DESCSPA
	'PIS reduction'															, ; //X3_DESCENG
	'@E 99.99'																, ; //X3_PICTURE
	''																		, ; //X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	5																		, ; //X3_TAMANHO
	2																		, ; //X3_DECIMAL
	'Red.Cofins'															, ; //X3_TITULO
	'Red.Cofins'															, ; //X3_TITSPA
	'COFINS red.'															, ; //X3_TITENG
	'Redu็ใo de Cofins'														, ; //X3_DESCRIC
	'Reducc de Cofins'														, ; //X3_DESCSPA
	'COFINS reduction'														, ; //X3_DESCENG
	'@E 99.99'																, ; //X3_PICTURE
	''																		, ; //X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	1																		, ; //X3_TAMANHO
	0																		, ; //X3_DECIMAL
	'Pauta Prod.'															, ; //X3_TITULO
	'Pauta Prod.'															, ; //X3_TITSPA
	'Prod. List'															, ; //X3_TITENG
	'Pauta Produto'															, ; //X3_DESCRIC
	'Pauta producto'														, ; //X3_DESCSPA
	'Product List'															, ; //X3_DESCENG
	'@!'																	, ; //X3_PICTURE
...
aAdd( aSX3, { ;
	...
	0																		, ; //X3_DECIMAL
	'Uf Busca'																, ; //X3_TITULO
	'E/D/R Busque'															, ; //X3_TITSPA
	''																		, ; //X3_TITENG
	'Uf Busca'																, ; //X3_DESCRIC
	'Est/Dist/Reg. busqueda'												, ; //X3_DESCSPA
	''																		, ; //X3_DESCENG
	'@!'																	, ; //X3_PICTURE
	'Pertence("12")'														, ; //X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	...
	''																		, ; //X3_OBRIGAT
	''																		, ; //X3_VLDUSER
	'1=Destino;2=Origem'													, ; //X3_CBOX
	'1=Destino;2=Origen'													, ; //X3_CBOXSPA
	'1=Destino;2=Origem'													, ; //X3_CBOXENG
	''																		, ; //X3_PICTVAR
	''																		, ; //X3_WHEN
	''																		, ; //X3_INIBRW
	''																		, ; //X3_GRPSXG
...
aAdd( aSX3, { ;
	...
	4																		, ; //X3_TAMANHO
	0																		, ; //X3_DECIMAL
	'Tab.Nat.Rec.'															, ; //X3_TITULO
	'Tab.Mod.Ingr'															, ; //X3_TITSPA
	''																		, ; //X3_TITENG
	'Tab. Nat. Receita'														, ; //X3_DESCRIC
	'Tab. Mod. Ingreso'														, ; //X3_DESCSPA
	''																		, ; //X3_DESCENG
	'@!'																	, ; //X3_PICTURE
	"Vazio() .OR. ExistCpo('CCZ')"											, ; //X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(160)					, ; //X3_USADO
	''																		, ; //X3_RELACAO
...
aAdd( aSX3, { ;
	...
	3																		, ; //X3_TAMANHO
	0																		, ; //X3_DECIMAL
	'Cod.Nat.Rec.'															, ; //X3_TITULO
	'Cod.Mod.Ingr'															, ; //X3_TITSPA
	''																		, ; //X3_TITENG
	'C๓d. Natureza da Receita'												, ; //X3_DESCRIC
	'C๓d.Modalida Ingreso'													, ; //X3_DESCSPA
	''																		, ; //X3_DESCENG
	'@!'																	, ; //X3_PICTURE
	'ExistCpo("CCZ",GDFieldGet("DZ_TNATREC")+M->DZ_CNATREC)'				, ; //X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(160)					, ; //X3_USADO
	''																		, ; //X3_RELACAO
...
aAdd( aSX3, { ;
	...
	2																		, ; //X3_TAMANHO
	0																		, ; //X3_DECIMAL
	'Grp.Nat.Rec.'															, ; //X3_TITULO
	'Grp.Mod.Ingr'															, ; //X3_TITSPA
	''																		, ; //X3_TITENG
	'Grupo Nat. Receita'													, ; //X3_DESCRIC
	'Grupo Modal. Ingreso'													, ; //X3_DESCSPA
	''																		, ; //X3_DESCENG
	'@!'																	, ; //X3_PICTURE
	'ExistCpo("CCZ",GDFieldGet("DZ_TNATREC")+GDFieldGet("DZ_CNATREC")+M->DZ_GRUPONC,1)', ; //X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(160)					, ; //X3_USADO
	''																		, ; //X3_RELACAO
...
aAdd( aSX3, { ;
	...
	8																		, ; //X3_TAMANHO
	0																		, ; //X3_DECIMAL
	'Dt.Fim N. R.'															, ; //X3_TITULO
	'FchFin M.Ing'															, ; //X3_TITSPA
	''																		, ; //X3_TITENG
	'Dt.Fim Nat.Receita'													, ; //X3_DESCRIC
	'Fch.Fin Mod.Ingreso'													, ; //X3_DESCSPA
	''																		, ; //X3_DESCENG
	''																		, ; //X3_PICTURE
	''																		, ; //X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	6																		, ; //X3_TAMANHO
	2																		, ; //X3_DECIMAL
	'%Red.ICMS ST'															, ; //X3_TITULO
	'%Red.ICMS ST'															, ; //X3_TITSPA
	'%Red.ICMS ST'															, ; //X3_TITENG
	'% Reducao de ICMS ST'													, ; //X3_DESCRIC
	'% Reducao de ICMS ST'													, ; //X3_DESCSPA
	'% Reducao de ICMS ST'													, ; //X3_DESCENG
	'@E 999.99'																, ; //X3_PICTURE
	'Positivo() .And. M->DZ_BSICMST <= 100.00'								, ; //X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(160)					, ; //X3_USADO
	''																		, ; //X3_RELACAO
...
aAdd( aSX3, { ;
	...
	14																		, ; //X3_TAMANHO
	2																		, ; //X3_DECIMAL
	'Vl.Uni.Cig'															, ; //X3_TITULO
	'Vl.Uni.Cig'															, ; //X3_TITSPA
	'Vl.Uni.Cig'															, ; //X3_TITENG
	'Preco Unitแrio Cigarro'												, ; //X3_DESCRIC
	'Preco Unitแrio Cigarro'												, ; //X3_DESCSPA
	'Preco Unitแrio Cigarro'												, ; //X3_DESCENG
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑษออออออออออัออออออออออหอออออออัออออออออออออออออออออหออออออัอออออออออออออปฑฑ
ฑฑบ Programa ณ FSAtuSIX บ Autor ณ TOTVS Protheus     บ Data ณ  04/03/2013 บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
...
aAdd( aSIX, { ;
	'PDZ'																	, ; //INDICE
	'1'																		, ; //ORDEM
	'DZ_FILIAL+DZ_GRTRIB+DZ_GRPCLI+DZ_SEQUEN+DTOS(DZ_DTVALID)'				, ; //CHAVE
	'Grupo Trib. + Grp.Cli./For + Sequencia + Dt. Validade'					, ; //DESCRICAO
	'Grupo Trib. + Grp.Cli./Pro + Secuencia + Dt. Validade'					, ; //DESCSPA
	'Tax. Group + Grp Cust/Sup + Sequence + Dt. Validade'					, ; //DESCENG
	'S'																		, ; //PROPRI
	'21'																	, ; //F3
	''																		, ; //NICKNAME
	'S'																		} ) //SHOWPESQ
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑษออออออออออัออออออออออหอออออออัออออออออออออออออออออหออออออัอออออออออออออปฑฑ
ฑฑบ Programa ณ FSAtuSX7 บ Autor ณ TOTVS Protheus     บ Data ณ  04/03/2013 บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
...
aAdd( aSX7, { ;
	'DZ_TNATREC'															, ; //X7_CAMPO
	'001'																	, ; //X7_SEQUENC
	'CCZ->CCZ_GRUPO'														, ; //X7_REGRA
	'DZ_GRUPONC'															, ; //X7_CDOMIN
	'P'																		, ; //X7_TIPO
	'N'																		, ; //X7_SEEK
	'CCZ'																	, ; //X7_ALIAS
	1																		, ; //X7_ORDEM
...
aAdd( aSX7, { ;
	'DZ_TNATREC'															, ; //X7_CAMPO
	'002'																	, ; //X7_SEQUENC
	'CCZ->CCZ_DTFIM'														, ; //X7_REGRA
	'DZ_DTFIMNT'															, ; //X7_CDOMIN
	'P'																		, ; //X7_TIPO
	'N'																		, ; //X7_SEEK
	'CCZ'																	, ; //X7_ALIAS
	1																		, ; //X7_ORDEM
...
aAdd( aSX7, { ;
	'DZ_TNATREC'															, ; //X7_CAMPO
	'003'																	, ; //X7_SEQUENC
	'CCZ->CCZ_ALQPIS'														, ; //X7_REGRA
	'DZ_ALIQPIS'															, ; //X7_CDOMIN
	'P'																		, ; //X7_TIPO
	'N'																		, ; //X7_SEEK
	'CCZ'																	, ; //X7_ALIAS
	1																		, ; //X7_ORDEM
	''																		, ; //X7_CHAVE
	'S'																		, ; //X7_PROPRI
	"!(GDFIELDGET('DZ_TNATREC')$'4311')"									} ) //X7_CONDIC

aAdd( aSX7, { ;
	'DZ_TNATREC'															, ; //X7_CAMPO
	'004'																	, ; //X7_SEQUENC
	'CCZ->CCZ_ALQCOF'														, ; //X7_REGRA
	'DZ_ALIQCOF'															, ; //X7_CDOMIN
	'P'																		, ; //X7_TIPO
	'N'																		, ; //X7_SEEK
	'CCZ'																	, ; //X7_ALIAS
	1																		, ; //X7_ORDEM
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑษออออออออออัออออออออออหอออออออัออออออออออออออออออออหออออออัอออออออออออออปฑฑ
ฑฑบ Programa ณ MyOpenSM0บ Autor ณ TOTVS Protheus     บ Data ณ  04/03/2013 บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
