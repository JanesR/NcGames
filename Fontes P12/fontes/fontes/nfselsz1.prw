...
Local Cabec1 := ""
Local Cabec2 := ""
Local cEmpEFil := cLinkRas  := U_MyNewSx6('NCG_200007','0103','N','Empresa e filial para valida็ใo WMS para emissใo de Romaneio.','','', .F. )
...
_cQry+=" SZ1.Z1_CLIENTE = SF2.F2_CLIENTE AND "
_cQry+=" SZ1.Z1_LOJA = SF2.F2_LOJA AND "
_cQry+=" SZ1.Z1_MARK = '"+cMark+"' AND "
_cQry+=" SZ1.Z1_STATUS = 'A' AND SZ1.D_E_L_E_T_ = ' ' AND SF2.F2_TRANSP <> ' '"
...
While !Eof() .AND. _cUnq <> SQL->DOC+SQL->SERIE+SQL->CLIENTE+SQL->LOJA
	...
	/*Acrescentado a valida็ใo da empresa e filial para usar valida็ใo do WMS*/
	/*If  cNumEmp == cEmpEFil
		lverwms := VerWMS(cPed)
		If lverwms
