...
//Self:cQuery += "               and WCES.CES_NUM_DOCUMENTO_WMS = ( 																					"
//Self:cQuery += "                     select max(CES_NUM_DOCUMENTO_WMS)																				"
//Self:cQuery += "                     from WMS.TB_WMSINTERF_CANC_ENT_SAI 																			"
//Self:cQuery += "                     where  CES_NUM_DOCUMENTO='"+ Self:cPedido +"'																				"
//Self:cQuery += "                      )																												"
