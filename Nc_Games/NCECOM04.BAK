...
User Function NcEcom04()
	...
	Local cTabNotEnv	:= Alltrim(U_MyNewSX6("NC_TABNENV","028;","C","Tabelas de Pre็o que nใo serใo enviadas","","",.F. )   )
	Local nVlrOfer
	...
	//criar parametro para as tabelas que nใo serใo enviados ao ciashop
