...
/*/
//--------------------------------------------------------------------
User Function UPDGRPCT( cEmpAmb, cFilAmb )
...
If lOk
	...
	If !Empty( aMarcadas )
		If lAuto .OR. MsgNoYes( "Confirma a atualização dos dicionários ?", cTitulo )
			...
			If lAuto
				If lOk
					MsgStop( "Atualização Realizada.", "UPDGRPCT" )
				Else
					MsgStop( "Atualização não Realizada.", "UPDGRPCT" )
				EndIf
				dbCloseAll()
			Else
				If lOk
...
aAdd( aSX2, { ;
	'PZ4'																	, ; //X2_CHAVE
	cPath																	, ; //X2_PATH
	'PZ4'+cEmpr																, ; //X2_ARQUIVO
	'GRUPO CONTABIL DA TES'													, ; //X2_NOME
	'GRUPO CONTABIL DA TES'													, ; //X2_NOMESPA
	'GRUPO CONTABIL DA TES'													, ; //X2_NOMEENG
	0																		, ; //X2_DELET
	'C'																		, ; //X2_MODO
	''																		, ; //X2_TTS
	''																		, ; //X2_ROTINA
...
aAdd( aSIX, { ;
	'PZ4'																	, ; //INDICE
	'1'																		, ; //ORDEM
	'PZ4_FILIAL+PZ4_CODIGO+PZ4_DESCRI'										, ; //CHAVE
	'Código+Descrição'														, ; //DESCRICAO
	'Código+Descrição'														, ; //DESCSPA
	'Código+Descrição'														, ; //DESCENG
	'U'																		, ; //PROPRI
	''																		, ; //F3
	''																		, ; //NICKNAME
	'N'																		} ) //SHOWPESQ
...
aAdd( aSXB, { ;
	...
	'01'																	, ; //XB_SEQ
	'DB'																	, ; //XB_COLUNA
	'Grupo Contabil Tes'													, ; //XB_DESCRI
	'Grupo Contabil Tes'													, ; //XB_DESCSPA
	'Grupo Contabil Tes'													, ; //XB_DESCENG
	'PZ4'																	} ) //XB_CONTEM
...
aAdd( aSXB, { ;
	...
	'01'																	, ; //XB_SEQ
	'01'																	, ; //XB_COLUNA
	'Código+descrição'														, ; //XB_DESCRI
	'Código+descrição'														, ; //XB_DESCSPA
	'Código+descrição'														, ; //XB_DESCENG
	''																		} ) //XB_CONTEM
