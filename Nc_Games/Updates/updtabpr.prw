...
/*/
//--------------------------------------------------------------------
User Function UPDTABPR( cEmpAmb, cFilAmb )
...
If lOk
	...
	If !Empty( aMarcadas )
		If lAuto .OR. MsgNoYes( "Confirma a atualização dos dicionários ?", cTitulo )
			...
			If lAuto
				If lOk
					MsgStop( "Atualização Realizada.", "UPDTABPR" )
				Else
					MsgStop( "Atualização não Realizada.", "UPDTABPR" )
				EndIf
				dbCloseAll()
			Else
				If lOk
...
aAdd( aSX3, {'SC5','M6','C5_YVFRTRA','N',14,2,'Frete Transf','Frete Transf','Frete Transf','Frete Transf','Frete Transf','Frete Transf','@E 99,999,999,999.99','',Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) +Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) +Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(160),'','',0,Chr(254) + Chr(192),'','','U','N','V','R','','','','','','','','','','4','',''} )
aAdd( aSX3, {'SC5','M7','C5_YPFRTRA','N',6,2,'%FreteTransf','%FreteTransf','%FreteTransf','% Frete Transferencia','% Frete Transferencia','% Frete Transferencia','@E 999.99','',Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) +Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) +Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128),'','',0,Chr(254) + Chr(192),'','','U','N','V','R','','','','','','','','','','4','',''} )
aAdd( aSX3, {'SC5','M8','C5_YVSETRA','N',14,2,'SeguroTransf','SeguroTransf','SeguroTransf','Seguro Transferencia','Seguro Transferencia','Seguro Transferencia','@E 99,999,999,999.99','',Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) +Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) +Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(160),'','',0,Chr(254) + Chr(192),'','','U','N','V','R','','','','','','','','','','4','',''} )
aAdd( aSX3, {'SC5','N1','C5_YPERPRO','N',8,3,'%Marg Promo','%Marg Promo','%Marg Promo','Margem Liquida Promoção','Margem Liquida Promoção','Margem Liquida Promoção','@E 9,999.999','',Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) +Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) +Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128),'','',0,Chr(254) + Chr(192),'','','U','N','V','R','','','','','','','','','','','',''} )
aAdd( aSX3, {'SC5','N2','C5_YPERNOR','N',8,3,'%Marg Normal','%Marg Normal','%Marg Normal','Margem Liquida Normal','Margem Liquida Normal','Margem Liquida Normal','@E 9,999.999','',Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) +Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) +Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128),'','',0,Chr(254) + Chr(192),'','','U','N','V','R','','','','','','','','','','','',''} )
aAdd( aSX3, {'SC5','N3','C5_YMAPROV','N',8,3,'Margem Aprov','Margem Aprov','Margem Aprov','Margem Aprovação','Margem Aprovação','Margem Aprovação','@E 9,999.999','',Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) +Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) +Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128),'','',0,Chr(254) + Chr(192),'','','U','N','V','R','','','','','','','','','','','',''} )
aAdd( aSX3, {'SC6','J9','C6_YPROMO','C',1,0,'Prc Promo','Prc Promo','Prc Promo','Prc Promo','Prc Promo','Prc Promo','','',Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) +Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) +Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(160),'"N"','',0,Chr(254) + Chr(192),'','','U','N','V','R','','','','','','','','','','','',''} )
//
