...
/*/
//--------------------------------------------------------------------
User Function UPDZAO( cEmpAmb, cFilAmb )
...
If lOk
	...
	If !Empty( aMarcadas )
		If lAuto .OR. MsgNoYes( "Confirma a atualização dos dicionários ?", cTitulo )
			...
			If lAuto
				If lOk
					MsgStop( "Atualização Realizada.", "UPDZAO" )
				Else
					MsgStop( "Atualização não Realizada.", "UPDZAO" )
				EndIf
				dbCloseAll()
			Else
				If lOk
...
aAdd( aSX2, { ;
	'ZAO'																	, ; //X2_CHAVE
	cPath																	, ; //X2_PATH
	'ZAO'+cEmpr																, ; //X2_ARQUIVO
	'TRANFERENCIA NF ENTRE EMPRESAS'										, ; //X2_NOME
	'TRANFERENCIA NF ENTRE EMPRESAS'										, ; //X2_NOMESPA
	'TRANFERENCIA NF ENTRE EMPRESAS'										, ; //X2_NOMEENG
	0																		, ; //X2_DELET
	'E'																		, ; //X2_MODO
	''																		, ; //X2_TTS
	''																		, ; //X2_ROTINA
...
aAdd( aSX3, { ;
	...
	6																		, ; //X3_TAMANHO
	0																		, ; //X3_DECIMAL
	'Forn.Destino'															, ; //X3_TITULO
	'Forn.Destino'															, ; //X3_TITSPA
	'Forn.Destino'															, ; //X3_TITENG
	'Fonecedor Destino'														, ; //X3_DESCRIC
	'Fonecedor Destino'														, ; //X3_DESCSPA
	'Fonecedor Destino'														, ; //X3_DESCENG
	''																		, ; //X3_PICTURE
	''																		, ; //X3_VALID
	...
	'R'																		, ; //X3_CONTEXT
	''																		, ; //X3_OBRIGAT
	'Vazio() .Or. ExistCpo("SA2")'											, ; //X3_VLDUSER
	''																		, ; //X3_CBOX
	''																		, ; //X3_CBOXSPA
	''																		, ; //X3_CBOXENG
	''																		, ; //X3_PICTVAR
...
aAdd( aSX3, { ;
	...
	2																		, ; //X3_TAMANHO
	0																		, ; //X3_DECIMAL
	'Loja Destino'															, ; //X3_TITULO
	'Loja Destino'															, ; //X3_TITSPA
	'Loja Destino'															, ; //X3_TITENG
	'Loja Destino'															, ; //X3_DESCRIC
	'Loja Destino'															, ; //X3_DESCSPA
	'Loja Destino'															, ; //X3_DESCENG
	''																		, ; //X3_PICTURE
	''																		, ; //X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	...
	'R'																		, ; //X3_CONTEXT
	''																		, ; //X3_OBRIGAT
	'Vazio() .Or. ExistCpo("SA2",M->A1_YFORDES+M->A1_YLOJDES)'				, ; //X3_VLDUSER
	''																		, ; //X3_CBOX
	''																		, ; //X3_CBOXSPA
	''																		, ; //X3_CBOXENG
	''																		, ; //X3_PICTVAR
...
aAdd( aSX3, { ;
	...
	2																		, ; //X3_TAMANHO
	0																		, ; //X3_DECIMAL
	'Emp.Destino'															, ; //X3_TITULO
	'Emp.Destino'															, ; //X3_TITSPA
	'Emp.Destino'															, ; //X3_TITENG
	'Empresa Destino'														, ; //X3_DESCRIC
	'Empresa Destino'														, ; //X3_DESCSPA
	'Empresa Destino'														, ; //X3_DESCENG
	''																		, ; //X3_PICTURE
	''																		, ; //X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	'Filial Destino'														, ; //X3_DESCRIC
	'Filial Destino'														, ; //X3_DESCSPA
	'Filial Destino'														, ; //X3_DESCENG
	''																		, ; //X3_PICTURE
	''																		, ; //X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	2																		, ; //X3_TAMANHO
	0																		, ; //X3_DECIMAL
	'FilialOrigem'															, ; //X3_TITULO
	'FilialOrigem'															, ; //X3_TITSPA
	'FilialOrigem'															, ; //X3_TITENG
...
aAdd( aSX3, { ;
	...
	'Nf Origem'																, ; //X3_TITSPA
	'Nf Origem'																, ; //X3_TITENG
	'Nf Origem'																, ; //X3_DESCRIC
	'Nf Origem'																, ; //X3_DESCSPA
	'Nf Origem'																, ; //X3_DESCENG
	''																		, ; //X3_PICTURE
	''																		, ; //X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	6																		, ; //X3_TAMANHO
	0																		, ; //X3_DECIMAL
	'Cliente Orig'															, ; //X3_TITULO
	'Cliente Orig'															, ; //X3_TITSPA
	'Cliente Orig'															, ; //X3_TITENG
	'Cleinte Origem'														, ; //X3_DESCRIC
	'Cleinte Origem'														, ; //X3_DESCSPA
	'Cleinte Origem'														, ; //X3_DESCENG
	''																		, ; //X3_PICTURE
	''																		, ; //X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	2																		, ; //X3_TAMANHO
	0																		, ; //X3_DECIMAL
	'Loja Origem'															, ; //X3_TITULO
	'Loja Origem'															, ; //X3_TITSPA
	'Loja Origem'															, ; //X3_TITENG
	'Loja Origem'															, ; //X3_DESCRIC
	'Loja Origem'															, ; //X3_DESCSPA
	'Loja Origem'															, ; //X3_DESCENG
	''																		, ; //X3_PICTURE
	''																		, ; //X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	2																		, ; //X3_TAMANHO
	0																		, ; //X3_DECIMAL
	'FilialDestin'															, ; //X3_TITULO
	'FilialDestin'															, ; //X3_TITSPA
	'FilialDestin'															, ; //X3_TITENG
	'Filial Destino'														, ; //X3_DESCRIC
	'Filial Destino'														, ; //X3_DESCSPA
	'Filial Destino'														, ; //X3_DESCENG
	''																		, ; //X3_PICTURE
...
aAdd( aSX3, { ;
	...
	9																		, ; //X3_TAMANHO
	0																		, ; //X3_DECIMAL
	'Nf Destino'															, ; //X3_TITULO
	'Nf Destino'															, ; //X3_TITSPA
	'Nf Destino'															, ; //X3_TITENG
	'Nf Destino'															, ; //X3_DESCRIC
	'Nf Destino'															, ; //X3_DESCSPA
	'Nf Destino'															, ; //X3_DESCENG
	''																		, ; //X3_PICTURE
	''																		, ; //X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	3																		, ; //X3_TAMANHO
	0																		, ; //X3_DECIMAL
	'SerieDestino'															, ; //X3_TITULO
	'SerieDestino'															, ; //X3_TITSPA
	'SerieDestino'															, ; //X3_TITENG
	'Serie Destino'															, ; //X3_DESCRIC
	'Serie Destino'															, ; //X3_DESCSPA
	'Serie Destino'															, ; //X3_DESCENG
	''																		, ; //X3_PICTURE
	''																		, ; //X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	6																		, ; //X3_TAMANHO
	0																		, ; //X3_DECIMAL
	'Fonrece Dest'															, ; //X3_TITULO
	'Fonrece Dest'															, ; //X3_TITSPA
	'Fonrece Dest'															, ; //X3_TITENG
	'Fornecedor Destino'													, ; //X3_DESCRIC
	'Fornecedor Destino'													, ; //X3_DESCSPA
	'Fornecedor Destino'													, ; //X3_DESCENG
	''																		, ; //X3_PICTURE
	''																		, ; //X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	'Dt. Digitacao'															, ; //X3_DESCRIC
	'Dt. Digitacao'															, ; //X3_DESCSPA
	'Dt. Digitacao'															, ; //X3_DESCENG
	''																		, ; //X3_PICTURE
	''																		, ; //X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(160)					, ; //X3_USADO
	'FWLEUSERLG("ZAO_USERGI", 1)+"-"+FWLEUSERLG("ZAO_USERGI", 2)'			, ; //X3_RELACAO
	''																		, ; //X3_F3
	0																		, ; //X3_NIVEL
	Chr(254) + Chr(192)														, ; //X3_RESERV
	''																		, ; //X3_CHECK
	...
	''																		, ; //X3_PICTVAR
	''																		, ; //X3_WHEN
	'FWLEUSERLG("ZAO_USERGI", 1)+"-"+FWLEUSERLG("ZAO_USERGI", 2)'			, ; //X3_INIBRW
	''																		, ; //X3_GRPSXG
	''																		, ; //X3_FOLDER
	''																		, ; //X3_PYME
	''																		} ) //X3_AGRUP
...
aAdd( aSIX, { ;
	'ZAO'																	, ; //INDICE
	'1'																		, ; //ORDEM
	'ZAO_FILIAL+ZAO_EMPORI+ZAO_FILORI+ZAO_NFORIG+ZAO_SERORI+ZAO_CLIORI+ZAO_LOJORI', ; //CHAVE
	'Emp.Origem+FilialOrigem+Nf Origem+Serie Origem+Cliente Orig+Loja Orige'	, ; //DESCRICAO
	'Emp.Origem+FilialOrigem+Nf Origem+Serie Origem+Cliente Orig+Loja Orige'	, ; //DESCSPA
	'Emp.Origem+FilialOrigem+Nf Origem+Serie Origem+Cliente Orig+Loja Orige'	, ; //DESCENG
	'U'																		, ; //PROPRI
	''																		, ; //F3
	''																		, ; //NICKNAME
	'S'																		} ) //SHOWPESQ
