...
/*/
//--------------------------------------------------------------------
User Function UPDZE4( cEmpAmb, cFilAmb )
...
If lOk
	...
	If !Empty( aMarcadas )
		If lAuto .OR. MsgNoYes( "Confirma a atualização dos dicionários ?", cTitulo )
			...
			If lAuto
				If lOk
					MsgStop( "Atualização Realizada.", "UPDZE4" )
				Else
					MsgStop( "Atualização não Realizada.", "UPDZE4" )
				EndIf
				dbCloseAll()
			Else
				If lOk
...
aAdd( aSX2, { ;
	...
	'REGRAS CONDIÇÃO DE PAGTO'												, ; //X2_NOME
	'REGRAS CONDIÇÃO DE PAGTO'												, ; //X2_NOMESPA
	'REGRAS CONDIÇÃO DE PAGTO'												, ; //X2_NOMEENG
	0																		, ; //X2_DELET
	'E'																		, ; //X2_MODO
	''																		, ; //X2_TTS
	''																		, ; //X2_ROTINA
...
aAdd( aSX3, { ;
	...
	'GETSXENUM( "ZE4","ZE4_COD")'											, ; //X3_RELACAO
	''																		, ; //X3_F3
	0																		, ; //X3_NIVEL
	Chr(254) + Chr(192)														, ; //X3_RESERV
	''																		, ; //X3_CHECK
...
aAdd( aSX3, { ;
	...
	'Descrição de Canal'													, ; //X3_DESCRIC
	'Descrição de Canal'													, ; //X3_DESCSPA
	'Descrição de Canal'													, ; //X3_DESCENG
	'@!'																	, ; //X3_PICTURE
	''																		, ; //X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	12																		, ; //X3_TAMANHO
	2																		, ; //X3_DECIMAL
	'Valor Maximo'															, ; //X3_TITULO
	'Valor Maximo'															, ; //X3_TITSPA
	'Valor Maximo'															, ; //X3_TITENG
	'Valor Máximo'															, ; //X3_DESCRIC
	'Valor Máximo'															, ; //X3_DESCSPA
	'Valor Máximo'															, ; //X3_DESCENG
	'@E 999,999,999.99'														, ; //X3_PICTURE
	''																		, ; //X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	3																		, ; //X3_TAMANHO
	0																		, ; //X3_DECIMAL
	'Prazo Medio'															, ; //X3_TITULO
	'Prazo Medio'															, ; //X3_TITSPA
	'Prazo Medio'															, ; //X3_TITENG
	'Prazo Medio'															, ; //X3_DESCRIC
	'Prazo Medio'															, ; //X3_DESCSPA
	'Prazo Medio'															, ; //X3_DESCENG
	'999'																	, ; //X3_PICTURE
	''																		, ; //X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	1																		, ; //X3_TAMANHO
	0																		, ; //X3_DECIMAL
	'Respeita Cad'															, ; //X3_TITULO
	'Respeita Cad'															, ; //X3_TITSPA
	'Respeita Cad'															, ; //X3_TITENG
	'Respeita Cadastro?'													, ; //X3_DESCRIC
	'Respeita Cadastro?'													, ; //X3_DESCSPA
	'Respeita Cadastro?'													, ; //X3_DESCENG
	'@!'																	, ; //X3_PICTURE
	''																		, ; //X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSIX, { ;
	'ZE4'																	, ; //INDICE
	'1'																		, ; //ORDEM
	'ZE4_FILIAL+ZE4_COD+ZE4_FLAG'											, ; //CHAVE
	'Código+Flag'															, ; //DESCRICAO
	'Código+Flag'															, ; //DESCSPA
	'Código+Flag'															, ; //DESCENG
	'U'																		, ; //PROPRI
	''																		, ; //F3
...
aAdd( aSIX, { ;
	'ZE4'																	, ; //INDICE
	'2'																		, ; //ORDEM
	'ZE4_FILIAL+ZE4_CANAL+ZE4_FLAG'											, ; //CHAVE
	'Canal+Flag'															, ; //DESCRICAO
	'Canal+Flag'															, ; //DESCSPA
	'Canal+Flag'															, ; //DESCENG
	'U'																		, ; //PROPRI
	''																		, ; //F3
...
//
aHlpPor := {}
aAdd( aHlpPor, 'Prazo Medio em dias' )
aHlpEng := {}
aHlpSpa := {}

PutHelp( "PZE4_PMEDIO", aHlpPor, aHlpEng, aHlpSpa, .T. )
cTexto += "Atualizado o Help do campo " + "ZE4_PMEDIO" + CRLF

aHlpPor := {}
aAdd( aHlpPor, 'Respeita cadastro do cliente?' )
aHlpEng := {}
aHlpSpa := {}

PutHelp( "PZE4_CRULES", aHlpPor, aHlpEng, aHlpSpa, .T. )
cTexto += "Atualizado o Help do campo " + "ZE4_CRULES" + CRLF
