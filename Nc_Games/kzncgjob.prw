...
ฑฑบFuncao    ณ KZNCGJOB	     บAutor  ณVinicius Almeida	  บData  ณ 16/05/2012 บฑฑ
...
User Function KZNCGJOB(aParam)   
		...
		Do While !FT_FEof()		 
			If SubStr(FT_FReadLn(),0,2) == "01"// Cabecalho
				...
				If clBloq == "2" .OR. EMPTY(clBloq)
					...
					EndIf
				Else
				Conout(clCliente + " estแ bloqueado.")
				EndIf
			EndIf
	 		If	!llIgual .And. (clBloq == "2" .OR. EMPTY(clBloq)) .And. llPerm
				If SubStr(FT_FReadLn(),0,2) == "02"// Pagamento
					KZImpPag()
				EndIf
				// Entrarแ nessa rotina apenas se a condicao de pagamento for parcelada e ja ter varrido todos os registros 02
			...
			Else
				...
				ElseIf !llPerm
					If aScan(alPerImp, AllTrim(cPedCom)+AllTrim(cCliFat)+AllTrim(cLjFat)+"P") == 0
						Conout( ProcName(0) + " Cliente/Loja: "+ AllTrim(cCliFat)+"/"+AllTrim(cLjFat)+" Nใo permite Importa็ใo de ORDERS. O pedido desse cliente nao foi importado." + Time() )
	...
	If Len(alPDCons) == 0
		Conout(OemToAnsi(dtoc( Date() )+" "+Time()+" "+"Nใo houve atualiza็ใo de status em nenhum Pedido."))
	Else
		DbSelectArea("ZAE")
		ZAE->(DbSetOrder(1))
	...
	Conout(OemToAnsi(dtoc( Date() )+" "+Time()+" "+"|======================================|"))	
	//Importacao do pedido sempre tera a revisใo como 001
...
ฑฑบ               ( __ /|\ __ )  Codefacttory 								  บฑฑ
ฑฑฬออออออออออัอออออออออออออออหอออออออัออออออออออออออออออออหออออออัออออออออออออนฑฑ
ฑฑบFuncao    ณ KZImpItens    บAutor  ณVinicius Almeida	  บData  ณ 16/05/2012 บฑฑ
ฑฑฬออออออออออุอออออออออออออออสอออออออฯออออออออออออออออออออสออออออฯออออออออออออนฑฑ
...
ฑฑบFuncao    ณKZFNum		 บAutor  ณRodrigo A. Tosin    บ Data ณ 09/03/2011  บฑฑ
ฑฑฬออออออออออุอออออออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
ฑฑบDesc.     ณGera numero sequencial da tabela especificada			 	   	   บฑฑ
ฑฑฬออออออออออุอออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออนฑฑ
ฑฑบUso       ณ			                                                       บฑฑ
ฑฑฬออออออออออุอออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออนฑฑ
ฑฑบParametrosณcAlias,cCampo													   บฑฑ  
ฑฑฬออออออออออุอออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออนฑฑ
ฑฑบRetorno   ณclNumero 							                               บฑฑ
...
User Function KZFNum(cAlias,cCampo) 
	...
	cCampo 			:= UPPER(cCampo) 
			...
			DBSelectArea(cAlias)
				...
				If &(cAlias) -> (EOF())
					...
					ElseIf ValType((cAlias) -> &(cCampo)) == "D"
						clNumero := Date()					 	
					Else
						ShowHelpDlg("Campo", {"Campo " + cCampo + " nใo suportado pela fun็ใo.",""},5,{"Escolha um campo que seja Caracter (C), Num้rico (N) ou Data (D)."	,""},5)			 				 		
						Return	
					EndIf									
				Else   
					If ValType((cAlias) -> &(cCampo)) == "C"
		...
		Else	
			...
			ShowHelpDlg("Campo nใo existente", {"Campo " + cCampo + " nใo existe no sistema.",""},5,{"Escolha um campo vแlido.",""},5)			 				 		
			Return	
...
ฑฑบPrograma  ณKZNCGJOB  บAutor  ณMicrosiga           บ Data ณ  01/08/15   บฑฑ
...
Local cAssunto 	:= "Inclusใo de EDI " + DtoC(Date()) + " - " + time()
...
cHtml +=" <title>Documento sem tรญtulo</title>"+CRLF
...
cHtml +=" <tr><td class='cabec_1'>Aviso de inclusใo de pedido EDI</td></tr>"+CRLF
