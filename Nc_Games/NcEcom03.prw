...
ฑฑบPrograma  ณNCECOM03  บAutor  ณMicrosiga           บ Data ณ  03/13/14   บฑฑ
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑษออออออออออัออออออออออหอออออออัออออออออออออออออออออหออออออัอออออออออออออปฑฑ
ฑฑบPrograma  ณNcEcom03  บAutor  ณOctavio A. Estevam  บ Data ณ  09/12/13   บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
ฑฑบDesc.     ณ Integra็ใo Protheus x CiaShop                              บฑฑ
ฑฑบ          ณ Atualiza o estoque na ferramenta Ciashop                   บฑฑ
ฑฑฬออออออออออุออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออนฑฑ
...
Local nEstSeg	:= U_MyNewSX6("EC_NCG0028","8","N","Estoque de seguran็a para integra็ใo de estoque B2B","","",.F. )
Local nArq
...
If !TRBEST->(EoF())
	...
	Do While !TRBEST->(EoF())
		...
		Else //Sem pre็o de consumidor cadastrado.
			cPrcCons	:= "99989"
			cPrcConsumi	:= "99990"
		EndIf
		...
		IF (TRBEST->ZC3_STATUS) == "02"  //Se o Produto estiver como 02(nใo vai para Site)
			cEstAtu := "0"
		...
		// //Linha acima implantada para atender parcialmente a importa็ใo do pre็o consumidor 28/02
	...
	For i:=1 to Len(_aXml)
		...
		Else
			//U_NcEcoLog("NcEcom04()","Erro de Execu็ใo : "+GetWSCError())
		...
		If oobj:lAtualizaEstoqueResult
			...
			If oobj:lAtualizaEstoqueResult
				U_COM09CAD("ESTOQUE","ESTOQUE","UPDATE","Atualiza็ใo do Estoque realizada com sucesso.","","")
				TRBEST->(DbGoTop())
				SB1->(DbSetOrder(1))
				Do While !TRBEST->(EoF())
...
Else
	//U_NcEcoLog("NcEcom03()","Nใo hแ saldos a serem exportados!")
Endif
TRBEST->(DbCloseArea())
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑษออออออออออัออออออออออหอออออออัออออออออออออออออออออหออออออัอออออออออออออปฑฑ
ฑฑบPrograma  ณNCECOM03  บAutor  ณMicrosiga           บ Data ณ  01/30/14   บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
ฑฑบDesc.     ณ                                                            บฑฑ
ฑฑบ          ณ                                                            บฑฑ
ฑฑฬออออออออออุออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออนฑฑ
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑษออออออออออัออออออออออหอออออออัออออออออออออออออออออหออออออัอออออออออออออปฑฑ
ฑฑบPrograma  ณNCECOM03  บAutor  ณMicrosiga           บ Data ณ  04/10/14   บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
ฑฑบDesc.     ณ                                                            บฑฑ
ฑฑบ          ณ                                                            บฑฑ
ฑฑฬออออออออออุออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออนฑฑ
...
Local cMsgYes := "A Rotina de Atualiza็ใo de estoque pode demorar alguns minutos. Deseja Prosseguir?"

If MsgYesno(cMsgYes)
	Processa( { ||U_NcEcom03()}, "Aguarde...", "Processando atualiza็ใo...",.F.)
Else
	Return
EndIf
