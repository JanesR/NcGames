...
//Self:cQuery += "                    THEN 'PENDENTE DE APROVAÇÃO' " 
//Self:cQuery += "                    ELSE ' '"  
...
//
//Self:cQuery += "         CASE WHEN C5.C5_YSTATUS = '02' THEN 'SUJEITO A APROVAÇÃO'	" 
...
//Self:cQuery += "         WHEN SUM(CASE WHEN P0B.P0B_STATUS ='01' THEN 1 ELSE 0 END) > 0 AND SUM(CASE WHEN P0B.P0B_STATUS =' ' THEN 1 ELSE 0 END) > 0 THEN 'PENDENTE DE APROVAÇÃO DE MARGEM'	" 
...
//Self:cQuery += "              THEN 'EM PROCESSO DE APROVAÇÃO DE MARGEM'	" 
//Self:cQuery += "         ELSE ' '	" 
//Self:cQuery += "         END LIBMARGEM,	" 
//
//Self:cQuery += "       CASE WHEN SUM(CASE WHEN C9.C9_DATALIB <> ' ' THEN 1 ELSE 0 END)>0 Or C5.C5_DTLIB <> ' '  THEN 'SIM'  ELSE 'NÃO' END AS LIBADM," 
//
...
//Self:cQuery += " WHEN DCE.DT_HOR_INICIO_SEPARACAO IS NOT NULL THEN 'SEPARAÇÃO INICIADA' " 
//Self:cQuery += " WHEN DCE.DT_HOR_DISPONIVEL_SEPARACAO IS NOT NULL THEN 'DISPONIVEL PARA SEPARAÇÃO' " 
