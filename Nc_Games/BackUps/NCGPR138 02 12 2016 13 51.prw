...
MsgRun("Processando os dados...","Processando",{|| Self:MontaExecutaQuery()})
	...
	If Val((Self:aAreaAtu)->(C5SF)) < 10 .Or. AllTrim((Self:aAreaAtu)->(CONDPAG)) == "000"
		...
		If (Self:aAreaAtu)->(ENTREGA) == aStatEntre[4]
			Self:oHtml:ValByName("cStatEntre",(Self:aAreaAtu)->(ENTREGA)+" - DATA DE ENTREGA: "+Self:retornaDataFormatada((Self:aAreaAtu)->(DTENTRE)))
		Else
