...
For nZ:= 1 to Len(aList)
	...
	If DbSeek(xFilial("SB1") + cProd)
		...
		If RecLock("SB1",.F.)
			SB1->B1_CONSUMI  := cPrecoSug
			SB1->B1_PRV1     := cPreco
			SB1->B1_XPRV18   := cPreco / GetAdvFVal("SZU","ZU_FATOR",xFilial("SZU")+"018"+cOrigemPro,1,0.00)
			SB1->B1_XPRV12   := cPreco / GetAdvFVal("SZU","ZU_FATOR",xFilial("SZU")+"012"+cOrigemPro,1,0.00)
			SB1->B1_XPRV07   := cPreco / GetAdvFVal("SZU","ZU_FATOR",xFilial("SZU")+"007"+cOrigemPro,1,0.00)
			SB1->(MsUnlock())
		EndIf
