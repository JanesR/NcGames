...
ฑฑบ Programa ณ NCGUD102 บ Autor ณ TOTVS Protheus     บ Data ณ  28/12/2012 บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
ฑฑบ Descricaoณ Funcao de update dos dicionแrios para compatibiliza็ใo     ณฑฑ
ฑฑบ          ณ                                                            บฑฑ
ฑฑฬออออออออออุออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออนฑฑ
ฑฑณ Uso      ณ NCGUD102   - Gerado por EXPORDIC / Upd. V.4.10.6 EFS       ณฑฑ
ฑฑศออออออออออฯออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออผฑฑ
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿
*/
User Function NCGUD102( cEmpAmb, cFilAmb )
...
If lOk
	...
	If !Empty( aMarcadas )
		...
		If lAuto
			If lOk
				MsgStop( "Atualiza็ใo Realizada.", "NCGUD102" )
				dbCloseAll()
			Else
				MsgStop( "Atualiza็ใo nใo Realizada.", "NCGUD102" )
				dbCloseAll()
			EndIf
		Else
			If lOk
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑษออออออออออัออออออออออหอออออออัออออออออออออออออออออหออออออัอออออออออออออปฑฑ
ฑฑบ Programa ณ FSTProc  บ Autor ณ TOTVS Protheus     บ Data ณ  28/12/2012 บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑษออออออออออัออออออออออหอออออออัออออออออออออออออออออหออออออัอออออออออออออปฑฑ
ฑฑบ Programa ณ FSAtuSX6 บ Autor ณ TOTVS Protheus     บ Data ณ  23/01/2013 บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
...
aAdd( aSX6, { ;
	...
	'NCG_000019'															, ; //X6_VAR
	'C'																		, ; //X6_TIPO
	'Usuแrio para acessar a base de dados do WMS'							, ; //X6_DESCRIC
	'Usuแrio para acessar a base de dados do WMS'							, ; //X6_DSCSPA
	'Usuแrio para acessar a base de dados do WMS'							, ; //X6_DSCENG
	''																		, ; //X6_DESC1
	''																		, ; //X6_DSCSPA1
	''																		, ; //X6_DSCENG1
	''																		, ; //X6_DESC2
...
aAdd( aSX6, { ;
	...
	'NCG_000030'															, ; //X6_VAR
	'C'																		, ; //X6_TIPO
	'Filiais aceitas na integra็ใo do WMS,'									, ; //X6_DESCRIC
	'Filiais aceitas na integra็ใo do WMS,'									, ; //X6_DSCSPA
	'Filiais aceitas na integra็ใo do WMS,'									, ; //X6_DSCENG
	'separadas por |'														, ; //X6_DESC1
	'separadas por |'														, ; //X6_DSCSPA1
	'separadas por |'														, ; //X6_DSCENG1
	''																		, ; //X6_DESC2
	''																		, ; //X6_DSCSPA2
	''																		, ; //X6_DSCENG2
	'03'																	, ; //X6_CONTEUD
...
aAdd( aSX6, { ;
	...
	'NCG_000033'															, ; //X6_VAR
	'C'																		, ; //X6_TIPO
	'Usuแrio para acessar a base de dados do Fretes'						, ; //X6_DESCRIC
	'Usuแrio para acessar a base de dados do Fretes'						, ; //X6_DSCSPA
	'Usuแrio para acessar a base de dados do Fretes'						, ; //X6_DSCENG
	''																		, ; //X6_DESC1
	''																		, ; //X6_DSCSPA1
	''																		, ; //X6_DSCENG1
	''																		, ; //X6_DESC2
...
aAdd( aSX6, { ;
	...
	'NCG_000034'															, ; //X6_VAR
	'C'																		, ; //X6_TIPO
	'Produto padrใo para inclusใo de NF Entrada'							, ; //X6_DESCRIC
	'Produto padrใo para inclusใo de NF Entrada'							, ; //X6_DSCSPA
	'Produto padrใo para inclusใo de NF Entrada'							, ; //X6_DSCENG
	'a partir do fretes'													, ; //X6_DESC1
	'a partir do fretes'													, ; //X6_DSCSPA1
	'a partir do fretes'													, ; //X6_DSCENG1
	''																		, ; //X6_DESC2
	''																		, ; //X6_DSCSPA2
	''																		, ; //X6_DSCENG2
	'080440730101'															, ; //X6_CONTEUD
	'080440730101'															, ; //X6_CONTSPA
	'080440730101'															, ; //X6_CONTENG
	'U'																		, ; //X6_PROPRI
	''																		} ) //X6_PYME
...
aAdd( aSX6, { ;
	...
	'NCG_000035'															, ; //X6_VAR
	'C'																		, ; //X6_TIPO
	'Produto padrใo de Pedagio para inclusใo de NF'					   		, ; //X6_DESCRIC
	'Produto padrใo de Pedagio para inclusใo de NF'					   		, ; //X6_DSCSPA
	'Produto padrใo de Pedagio para inclusใo de NF'					   		, ; //X6_DSCENG
	'Entrada a partir do fretes'											, ; //X6_DESC1
	'Entrada a partir do fretes'											, ; //X6_DSCSPA1
	'Entrada a partir do fretes'											, ; //X6_DSCENG1
	''																		, ; //X6_DESC2
	''																		, ; //X6_DSCSPA2
	''																		, ; //X6_DSCENG2
	'080440730101'															, ; //X6_CONTEUD
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑษออออออออออัออออออออออหอออออออัออออออออออออออออออออหออออออัอออออออออออออปฑฑ
ฑฑบ Programa ณ FSAtuSX2 บ Autor ณ TOTVS Protheus     บ Data ณ  28/12/2012 บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
...
aAdd( aSX2, { ;
	'P0A'																	, ; //X2_CHAVE
	cPath																	, ; //X2_PATH
	'P0A'+cEmpr																, ; //X2_ARQUIVO
	'INTEGRAวรO WMS'														, ; //X2_NOME
	'INTEGRAวรO WMS'														, ; //X2_NOMESPA
	'INTEGRAวรO WMS'														, ; //X2_NOMEENG
	0																		, ; //X2_DELET
	'C'																		, ; //X2_MODO
	''																		, ; //X2_TTS
	''																		, ; //X2_ROTINA
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑษออออออออออัออออออออออหอออออออัออออออออออออออออออออหออออออัอออออออออออออปฑฑ
ฑฑบ Programa ณ FSAtuSX3 บ Autor ณ TOTVS Protheus     บ Data ณ  28/12/2012 บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
...
aAdd( aSX3, { ;
	...
	'Exportado?'															, ; //X3_TITSPA
	'Exportado?'															, ; //X3_TITENG
	'Exportado?'															, ; //X3_DESCRIC
	'Exportado?'															, ; //X3_DESCSPA
	'Exportado?'															, ; //X3_DESCENG
	''																		, ; //X3_PICTURE
	''																		, ; //X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	'Indice'																, ; //X3_TITSPA
	'Indice'																, ; //X3_TITENG
	'Indice da Chave'														, ; //X3_DESCRIC
	'Indice da Chave'														, ; //X3_DESCSPA
	'Indice da Chave'														, ; //X3_DESCENG
	''																		, ; //X3_PICTURE
	''																		, ; //X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	''																		, ; //X3_OBRIGAT
	''																		, ; //X3_VLDUSER
	'1=Inclusใo;2=Altera็ใo;3=Exclusใo'										, ; //X3_CBOX
	''																		, ; //X3_CBOXSPA
	''																		, ; //X3_CBOXENG
	''																		, ; //X3_PICTVAR
	''																		, ; //X3_WHEN
...
aAdd( aSX3, { ;
	...
	'Desc. Erro'															, ; //X3_TITSPA
	'Desc. Erro'															, ; //X3_TITENG
	'Descri็ใo do erro'														, ; //X3_DESCRIC
	'Descri็ใo do erro'														, ; //X3_DESCSPA
	'Descri็ใo do erro'														, ; //X3_DESCENG
	''																		, ; //X3_PICTURE
	''																		, ; //X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	''																		, ; //X3_PICTURE
	'vazio() .or. ExistCpo("SA2",M->A4_YFORNEC)'							, ; //X3_VALID
	'€€€€€€€€€€€€€€ฐ'														, ; //X3_USADO
	''																		, ; //X3_RELACAO
	'FOR'																	, ; //X3_F3
	1																		, ; //X3_NIVEL
...
aAdd( aSX3, { ;
	...
	'Loja'																	, ; //X3_DESCENG
	''																		, ; //X3_PICTURE
	'Vazio() .Or. ExistCpo("SA2",M->A4_YFORNEC+M->A4_YLOJA)'				, ; //X3_VALID
	'€€€€€€€€€€€€€€ฐ'														, ; //X3_USADO
	''																		, ; //X3_RELACAO
	''																		, ; //X3_F3
	1																		, ; //X3_NIVEL
...
aAdd( aSX3, { ;
	...
	5																		, ; //X3_TAMANHO
	0																		, ; //X3_DECIMAL
	'Codigo WMS'															, ; //X3_TITULO
	'Codigo WMS'															, ; //X3_TITSPA
	'Codigo WMS'															, ; //X3_TITENG
	'Codigo WMS'															, ; //X3_DESCRIC
	'Codigo WMS'															, ; //X3_DESCSPA
	'Codigo WMS'															, ; //X3_DESCENG
	'@E 99999'																, ; //X3_PICTURE
	''																		, ; //X3_VALID
	'€€€€€€€€€€€€€€ฐ'														, ; //X3_USADO
	''																		, ; //X3_RELACAO
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑษออออออออออัออออออออออหอออออออัออออออออออออออออออออหออออออัอออออออออออออปฑฑ
ฑฑบ Programa ณ FSAtuSIX บ Autor ณ TOTVS Protheus     บ Data ณ  28/12/2012 บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
...
aAdd( aSIX, { ;
	'P0A'																	, ; //INDICE
	'1'																		, ; //ORDEM
	'P0A_FILIAL+P0A_CHAVE+P0A_TABELA'										, ; //CHAVE
	'Chave+Tabela'															, ; //DESCRICAO
	'Chave+Tabela'															, ; //DESCSPA
	'Chave+Tabela'															, ; //DESCENG
	'U'																		, ; //PROPRI
	''																		, ; //F3
	''																		, ; //NICKNAME
	'N'																		} ) //SHOWPESQ
...
aAdd( aSIX, { ;
	'SC9'																	, ; //INDICE
	'A'																		, ; //ORDEM
	'C9_FILIAL+C9_PEDIDO+C9_PRODUTO'										, ; //CHAVE
	'Pedido+Produto'														, ; //DESCRICAO
	'Pedido+Produto'														, ; //DESCSPA
	'Pedido+Produto'														, ; //DESCENG
	'U'																		, ; //PROPRI
	''																		, ; //F3
	'PEDPRODWMS'															, ; //NICKNAME
	'N'																		} ) //SHOWPESQ
...
aAdd( aSIX, { ;
	'SA4'																	, ; //INDICE
	'A'																		, ; //ORDEM
	'A4_FILIAL+A4_YCODWMS'													, ; //CHAVE
	'Codigo WMS'															, ; //DESCRICAO
	'Codigo WMS'															, ; //DESCSPA
	'Codigo WMS'															, ; //DESCENG
	'U'																		, ; //PROPRI
	''																		, ; //F3
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑษออออออออออัออออออออออหอออออออัออออออออออออออออออออหออออออัอออออออออออออปฑฑ
ฑฑบ Programa ณ FSAtuHlp บ Autor ณ TOTVS Protheus     บ Data ณ  28/12/2012 บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
...
//
aHlpPor := {}
aAdd( aHlpPor, 'Caso ocorra erro na exporta็ใo do' )
aAdd( aHlpPor, 'registro para a tabela do WMS, este' )
aAdd( aHlpPor, 'campo serแ preenchido com o erro' )
aAdd( aHlpPor, 'ocorrido.' )
aHlpEng := {}
aHlpSpa := {}

PutHelp( "PP0A_ERRO  ", aHlpPor, aHlpEng, aHlpSpa, .T. )
cTexto += "Atualizado o Help do campo " + "P0A_ERRO" + CRLF
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑษออออออออออัออออออออออหอออออออัออออออออออออออออออออหออออออัอออออออออออออปฑฑ
ฑฑบ Programa ณ MyOpenSM0บ Autor ณ TOTVS Protheus     บ Data ณ  28/12/2012 บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
