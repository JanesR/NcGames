...
ฑฑบPrograma  ณNCGWF103  บAutor  ณHermes Ferreira     บ Data ณ  10/12/12   บฑฑ
...
//Cria o array com os campos que serใo apresentados na markbrowse1

AADD(alCampos,{"P0B_OK"		,Nil,"Sele็ใo",""})
AADD(alCampos,{"P0B_PEDIDO",Nil,"Pedido",""})
If SX3->(dbSeek( "P0B_STATUS" ))
	AADD(alCampos,{{|| IIf(P0B->P0B_STATUS== '01',"Aguardando sua aprova็ใo", IIf(P0B->P0B_STATUS == '02',"Aguar. demais aprov. no mesmo nํvel", IIf(P0B->P0B_STATUS == '03',"Aguardando aprova็ใo nํvel superior", IIf(P0B->P0B_STATUS == '04',"Aprovado",IIf(P0B->P0B_STATUS == '05',"Reprovado",""))))) },Nil,"Status"+Space(20)})
EndIf
AADD(alCampos,{"P0B_CODCLI",Nil,"Cliente",""})
AADD(alCampos,{"P0B_LOJA"	,Nil,"Loja",""})
AADD(alCampos,{"P0B_NOMECL",Nil,"Nome Cliente",""})
AADD(alCampos,{"P0B_CODVEN",Nil,"C๓d. Vendedor",""})
...
{"Aprova็ใo em Massa"				,"U_wf103ApMas('A')"	,0,4} ,;
{"Reprova็ใo em Massa"				,"U_wf103ApMas('R')"	,0,4} ,;
{"Analise Margem Liquida"			,"U_WF103PV(1)"	,0,2} ,;
{"Observa็๕es sobre a Aprova็ใo"	,"U_WF103PV(2)"	,0,2} ,;
...
If !Empty(P0B->P0B_CODOBS)
	...
	Aviso("NCGCD102 - 15",@cMemoObs,{"Ok"},3,"Observa็ใo",,,.T.)
Else
	MsgAlert("Nใo hแ observa็๕es para esta al็ada.")
EndIf
Return
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑษออออออออออัออออออออออหอออออออัออออออออออออออออออออหออออออัอออออออออออออปฑฑ
ฑฑบPrograma  ณWF103ATU  บAutor  ณHermes		         บ Data ณ  15/12/12   บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
...
If !P0B->P0B_USER == Alltrim(cUserLog)
	Aviso("NCGWF103 - 02","S๓ permitido analise pelo aprovador "+UsrFullName(P0B->P0B_USER)+".",{"Ok"},3)
	Return
EndIf
...
If nOpc > 0
	...
	If P0B->P0B_STATUS == '01'
		...
		EndIf
	Else
		Aviso("NCGWF103 - 01","S๓ permitido aprovar/reprovar caso esteja aguardando alguma a็ใo para seu usuแrio.",{"Ok"},3)
	EndIf
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑษออออออออออัออออออออออหอออออออัออออออออออออออออออออหออออออัอออออออออออออปฑฑ
ฑฑบPrograma  ณMkTelaWF2 บAutor  ณAlberto Kibino      บ Data ณ  03/01/12   บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
ฑฑบDesc.     ณTela de aprova็ใo/Reprova็ใo de uma al็ada de P&L     	  บฑฑ
ฑฑฬออออออออออุออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออนฑฑ
ฑฑบUso       ณ NC Games                                                   บฑฑ
ฑฑศออออออออออฯออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออผฑฑ
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
...
Else
	...
	Aviso("NCGWF103 - 02","Nใo foi localizado o pedido deste processo de al็ada. Verifique se o pedido nใo foi excluํdo.",{"Ok"},3)
...
If P0B->P0B_STATUS<>'01'      
	If lShow
		MsgStop(UsrFullName(P0B->P0B_USER)+"-Pedido "+P0B->P0B_STATUS+"-"+IIf(P0B->P0B_STATUS== '01',"Aguardando sua aprova็ใo", IIf(P0B->P0B_STATUS == '02',"Aguar. demais aprov. no mesmo nํvel", IIf(P0B->P0B_STATUS == '03',"Aguardando aprova็ใo nํvel superior", IIf(P0B->P0B_STATUS == '04',"Aprovado",IIf(P0B->P0B_STATUS == '05',"Reprovado",""	 ))))))
	EndIf	
	Return
EndIf
If lShow
	...
	If Aviso("NCGWF103 - 15",@cMemoObs,{"Sim","Nใo"},3,"Confirma "+IIf(cChose == "R","Reprova็ใo","Aprova็ใo")+" do Pedido "+P0B->P0B_PEDIDO,,,.T.) == 1
		lIncMemo := .T.
	Else
		lIncMemo := .F.
	EndIf
...
If cChose == "R"
	P0B->(RecLock("P0B",.F.))
	P0B->P0B_STATU1 := 'R'         //adicionado para atender a solicita็ใo de rastreabilidade do Nelson
		...
		If &(cTabOrig)->(dbSeek(xFilial(cTabOrig)+ P0B->P0B_CHVIND ))
			...
			If &(cTabOrig)->(RecLock(cTabOrig,.F.))
				...
				ElseIf cTabOrig == "SC5"
					...
					P0B->(EnvMailStatus(Posicione("P09",1,xFilial("P09")+P0B_APROV,"P09_EMAIL"),"Retorno da aprova็ใo da Margem do Pedido de venda: "+ P0B_NUM,"Reprovado",P0B_PEDIDO))
					If lShow
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑษออออออออออัออออออออออหอออออออัออออออออออออออออออออหออออออัอออออออออออออปฑฑ
ฑฑบPrograma  ณFHeadPedv2บAutor  ณAlberto Kibino      บ Data ณ  03/01/13   บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
ฑฑบDesc.     ณMonta o Header dos pedidos de vendas                        บฑฑ
ฑฑฬออออออออออุออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออนฑฑ
...
//ณ Cria Ambiente/Objeto para tratamento de grade        ณ
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑษออออออออออัออออออออออหอออออออัออออออออออออออออออออหออออออัอออออออออออออปฑฑ
ฑฑบPrograma  ณWF103LEG  บAutor  ณHermes Ferreira      บ Data ณ  10/12/12  บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑษออออออออออัออออออออออหอออออออัออออออออออออออออออออหออออออัอออออออออออออปฑฑ
ฑฑบPrograma  ณENVWF103  บAutor  ณHermes Ferreira    บ Data ณ   20/12/12   บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
...
Local aAprovadores	:= {}
Local lTemPromo
Local cAprvGhost		:= AllTrim(U_MyNewSx6("NCG_000075","000254","C","Usuแrio que nใo serใo visualizados na aprova็ใo.","","",.F.))
...
If &(cTabOrig)->(dbSeek(xFilial(cTabOrig)+ ChaveInd ))
	...
	clAssunto := "Aprova็ใo do Pedido de Venda:"+SC5->C5_NUM+" Cliente:"+AllTrim(SC5->C5_NOMCLI)+" com margem de "+TranSform(SC5->C5_YPERLIQ,AvSx3("C5_YPERLIQ",6))
	...
	Else
		Aviso("NCGWF103 - 04","Nใo foi localizado o modelo HTML para envio do Workflow. Solicite ao Dpto. de Tecnologia da Informa็ใo para verificar os modelos HTML do Workflow do Analise de Margem Liquida.",{"Ok"},3)
		lReturn:=.F.
	EndIf
...
Else
	...
	Aviso("NCGWF103 - 05","Nใo foi localizado o modelo HTML para envio do link Workflow. Solicite ao Dpto. de Tecnologia da Informa็ใo para verificar os modelos HTML do Workflow do VPC/VEBA.",{"Ok"},3)
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑษออออออออออัออออออออออหอออออออัออออออออออออออออออออหออออออัอออออออออออออปฑฑ
ฑฑบPrograma  ณWF103RET  บAutor  ณHermes Ferreira    บ Data ณ   20/12/12   บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
...
If oProcRet <> Nil
	...
	If P0B->(dbSeek(xFilial("P0B")+cTipoAlc+cDocAlc+_cUser ))
		...
		If P0B->P0B_STATUS == "01"
			...
			If RecLock( "P0B", .F.)
				...
				If cAprRepr == "S"
					...
					P0B->P0B_STATU1 := 'A'         //adicionado para atender a solicita็ใo de rastreabilidade do Nelson
					P0B->P0B_DTLIB1 := MSDate()
					P0B->P0B_HRLIB  := Time()
		...
		Else
			...
			EnvMailStatus(_MailDest,"Retorno da aprova็ใo da Margem do Pedido de venda: "+ cDocAlc,_cStatus,cNumPV)
...
ฑฑณFuno    ณMta410Vis ณ Autor ณ Marco Bianchi         ณ Data ณ 01/12/06 ณฑฑ
ฑฑรฤฤฤฤฤฤฤฤฤฤลฤฤฤฤฤฤฤฤฤฤมฤฤฤฤฤฤฤมฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤมฤฤฤฤฤฤมฤฤฤฤฤฤฤฤฤฤดฑฑ
ฑฑณDescrio ณFuncao executada a partir da FillGetdados para validar cada ณฑฑ
ฑฑณ          ณregistro da tabela. Se retornar .T. FILLGETDADOS considera  ณฑฑ
ฑฑณ          ณo registro, se .F. despreza o registro.                     ณฑฑ
ฑฑรฤฤฤฤฤฤฤฤฤฤลฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤดฑฑ
ฑฑณSintaxe   ณMColsVis()                                                  ณฑฑ
ฑฑรฤฤฤฤฤฤฤฤฤฤลฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤดฑฑ
ฑฑณParametro ณ                                                            ณฑฑ
ฑฑณ          ณ                                                            ณฑฑ
ฑฑรฤฤฤฤฤฤฤฤฤฤลฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤดฑฑ
ฑฑณUso       ณ MATA410                                                    ณฑฑ
...
//ฺฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฟ
//ณ Verifica se este item foi digitada atraves de uma    ณ
//ณ grade, se for junta todos os itens da grade em uma   ณ
//ณ referencia , abrindo os itens so quando teclar enter ณ
//ณ na quantidade                                        ณ
//ภฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤู
...
//ณEfetua a Somatoria do Rodape                                            ณ
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑฺฤฤฤฤฤฤฤฤฤฤยฤฤฤฤฤฤฤฤฤฤยฤฤฤฤฤฤฤยฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤยฤฤฤฤฤฤยฤฤฤฤฤฤฤฤฤฤฟฑฑ
ฑฑณFuno    ณAfterCols ณ Autor ณ Marco Bianchi         ณ Data ณ 24/01/07 ณฑฑ
ฑฑรฤฤฤฤฤฤฤฤฤฤลฤฤฤฤฤฤฤฤฤฤมฤฤฤฤฤฤฤมฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤมฤฤฤฤฤฤมฤฤฤฤฤฤฤฤฤฤดฑฑ
ฑฑณDescrio ณFuncao executada apos inclusao de nova linha no aCols pela  ณฑฑ
ฑฑณ          ณFillgetDados.                                               ณฑฑ
ฑฑรฤฤฤฤฤฤฤฤฤฤลฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤดฑฑ
ฑฑณSintaxe   ณAfterCols()                                                 ณฑฑ
ฑฑรฤฤฤฤฤฤฤฤฤฤลฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤดฑฑ
ฑฑณParametro ณ                                                            ณฑฑ
ฑฑณ          ณ                                                            ณฑฑ
ฑฑรฤฤฤฤฤฤฤฤฤฤลฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤดฑฑ
...
If !lGrdMUlt
	...
	Else
		...
		//ณ Mesmo nao sendo um item digitado atraves de grade e' necessa-ณ
		//ณ rio criar o Array referente a este item para controle da     ณ
		//ณ grade                                                        ณ
...
If lCopia
	...
	//ฺฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฟ
	//ณ Estes campos nao podem ser copiados                  ณ
	//ภฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤู
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑษออออออออออัออออออออออหอออออออัออออออออออออออออออออหออออออัอออออออออออออปฑฑ
ฑฑบPrograma  ณA410InGrdMบAutor  ณAndre Anjos		 บ Data ณ  21/01/11   บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
ฑฑบDescricao ณ Funcao para inicialiar a grade multicampo				  บฑฑ
ฑฑฬออออออออออุออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออนฑฑ
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑษออออออออออัออออออออออหอออออออัออออออออออออออออออออหออออออัอออออออออออออปฑฑ
ฑฑบPrograma  ณNCGPR107  บAutor  ณMicrosiga           บ Data ณ  01/05/13   บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
ฑฑบDesc.     ณ                                                            บฑฑ
ฑฑบ          ณ                                                            บฑฑ
ฑฑฬออออออออออุออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออนฑฑ
...
ฑฑษออออออออออัออออออออออหอออออออัออออออออออออออออออออหออออออัอออออออออออออปฑฑ
ฑฑบPrograma  ณNCGWF103  บAutor  ณMicrosiga           บ Data ณ  01/29/13   บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
ฑฑบDesc.     ณ                                                            บฑฑ
ฑฑบ          ณ                                                            บฑฑ
ฑฑฬออออออออออุออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออนฑฑ
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑษออออออออออัออออออออออหอออออออัออออออออออออออออออออหออออออัอออออออออออออปฑฑ
ฑฑบPrograma  ณNCGWF103  บAutor  ณMicrosiga           บ Data ณ  03/26/13   บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
ฑฑบDesc.     ณ                                                            บฑฑ
ฑฑบ          ณ                                                            บฑฑ
ฑฑฬออออออออออุออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออนฑฑ
...
"C"												,;
"Usuarios com direito a Filtro na Aprova็ใo da Margem"	,;
"Usuarios com direito a Filtro na Aprova็ใo da Margem"	,;
"Usuarios com direito a Filtro na Aprova็ใo da Margem"	,;
.F. ))
...
PutSX1(cPerg, "01", "Somente Pedidos", "", "", "mv_ch1", "N", 1, 0, 3, "C", "", "", "", "", "mv_par01", "Aprovado", "Aprovado", "Aprovado", "", "Reprovado", "Reprovado", "Reprovado", "Em Aprova็ใo","Em Aprova็ใo", "Em Aprova็ใo", "Sem Filtro", "Sem Filtro", "Sem Filtro", "", "","",,,, )
If  !Pergunte(cPerg)
	Return
EndIF
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑษออออออออออัออออออออออหอออออออัออออออออออออออออออออหออออออัอออออออออออออปฑฑ
ฑฑบPrograma  ณNCGWF103  บAutor  ณMicrosiga           บ Data ณ  03/29/13   บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
ฑฑบDesc.     ณ                                                            บฑฑ
ฑฑบ          ณ                                                            บฑฑ
ฑฑฬออออออออออุออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออนฑฑ
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑษออออออออออัออออออออออหอออออออัออออออออออออออออออออหออออออัอออออออออออออปฑฑ
ฑฑบPrograma  ณNCGWF103  บAutor  ณMicrosiga           บ Data ณ  04/14/13   บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
ฑฑบDesc.     ณ                                                            บฑฑ
ฑฑบ          ณ                                                            บฑฑ
ฑฑฬออออออออออุออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออนฑฑ
...
If !SC5->(DbSeek(xFilial("SC5")+P0B->P0B_PEDIDO ))
	MsgStop("Pedido de venda "+P0B->P0B_PEDIDO+" nใo encontrado")
ElseIf 	nChamada==1
	U_PR107Margem()
ElseIf 	nChamada==2
...
If !P0B->P0B_USER == Alltrim(cUserLog)
	Aviso("NCGWF103 - WF103Apr","S๓ permitido analise pelo aprovador "+UsrFullName(P0B->P0B_USER)+".",{"Ok"},3)
	Return
EndIf
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑษออออออออออัออออออออออหอออออออัออออออออออออออออออออหออออออัอออออออออออออปฑฑ
ฑฑบPrograma  ณNCGWF103  บAutor  ณMicrosiga           บ Data ณ  09/24/13   บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
ฑฑบDesc.     ณ                                                            บฑฑ
ฑฑบ          ณ                                                            บฑฑ
ฑฑฬออออออออออุออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออนฑฑ
...
If cTipo=="A"
	cObservacao	:= "Pedidos com Aprova็ใo em Lote "
ElseIf cTipo=="R"	
	cObservacao	:= "Pedidos com Reprova็ใo em Lote "
EndIf	
...
If !lMarcado
	MsgAlert("Nใo hแ Pedido de Venda apto para processamento.")
Else                                                  
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑษออออออออออัออออออออออหอออออออัออออออออออออออออออออหออออออัอออออออออออออปฑฑ
ฑฑบPrograma  ณNCGWF103  บAutor  ณMicrosiga           บ Data ณ  09/25/13   บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
ฑฑบDesc.     ณ                                                            บฑฑ
ฑฑบ          ณ                                                            บฑฑ
ฑฑฬออออออออออุออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออนฑฑ
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑษออออออออออัออออออออออหอออออออัออออออออออออออออออออหออออออัอออออออออออออปฑฑ
ฑฑบPrograma  ณNCGWF103  บAutor  ณMicrosiga           บ Data ณ  12/13/13   บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
ฑฑบDesc.     ณ                                                            บฑฑ
ฑฑบ          ณ                                                            บฑฑ
ฑฑฬออออออออออุออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออนฑฑ
...
Private lInverte  	:= .F.
Private alCampos  	:= {}
Private cUsr		:= Alltrim(U_MyNewSX6("NCG_APAUT","000307;000384;000411;000086","C","Usuแrios autorizados a aprovar automaticamente as al็adas","","",.F. ))

Private aRotina := { {"Pesquisar"	,"AxPesqui"			,0,1} ,;
					 {"Visualizar"			,"U_WF103ATU()"	,0,2} ,;
					 {"Aprova็ใo Automatica","U_WF103AUT()"	,0,4}}
...
If !__cUserId$cUsr
	MsgStop("Usuแrio sem autoriza็ใo para utilizar a rotina")
	Return
EndIf
...
Local cChaveP0B    
Local lShow:=.F.
Local cObservacao:="Aprova็ใo Automatica"

If !P0B->P0B_STATUS=="01"
	MsgStop("Posicione no status Aguardando sua aprova็ใo")
	Return 
EndIf 
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑษออออออออออัออออออออออหอออออออัออออออออออออออออออออหออออออัอออออออออออออปฑฑ
ฑฑบPrograma  ณNCGWF103  บAutor  ณMicrosiga           บ Data ณ  08/05/14   บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
ฑฑบDesc.     ณ                                                            บฑฑ
ฑฑบ          ณ                                                            บฑฑ
ฑฑฬออออออออออุออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออนฑฑ
