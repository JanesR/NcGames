...
msgalert("Esta rotina tem o objetivo de ajustar a TOP_FIELD se baseando na tabela SX3.Esta rotina gera uma tabela de resultado CHECKTOP no banco de dados para conferencia.Esta rotina funciona somente para banco de dados.")
...
While !Eof()
	...
	While !Eof()
		// ****** tratar a tela********
		//@ 15,10 Say "  Verificando Tabela "+SX2->X2_ARQUIVO
		//@ 16,10 Say Space(59)
		//@ 17,10 Say Space(59)   
		// ******************************** 
...
// Substituido pelo assistente de conversao do AP5 IDE em 05/07/01 ==> Static Function CheckTabela(cArquivo,cBanco)
...
// Carrega Estrutura do dicionario de dados da tabela corrente em funçao da TOP_FIELD
// Este array terá somente os campos do Tipo Data, Numerico e Logico.
