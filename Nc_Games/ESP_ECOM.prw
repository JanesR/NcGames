...
TRCell():New(oPreNota,"AITEM07",/*Tabela*/,STR0057					 ,PesqPictQt("C6_QTDRESE"	    ),TamSx3("C6_QTDRESE"	)[1],/*lPixel*/,{|| aItemPed[nItem][07] 																	})	// "Quant."
...
TRFunction():New(oPreNota:Cell("AITEM07"),"AITEM07"/* cID */,"ONPRINT",/*oBreak*/,/*cTitle*/,PesqPict("SC6","C6_QTDRESE",20),{|| nTotQtd }/*uFormula*/,.T./*lEndSection*/,.F./*lEndReport*/,/*lEndPage*/)
...
#IFDEF TOP
	If TcSrvType() <> "AS/400"
		...
		SC6.C6_TES,SC6.C6_CF,SC6.C6_QTDRESE,SC6.C6_PRUNIT,SC6.C6_VALDESC,
...
While !oReport:Cancel() .And. !((cAliasSC5)->(Eof())) .and. xFilial("SC5")==(cAliasSC5)->C5_FILIAL
	...
	While !oReport:Cancel() .And. !((cAliasSC6)->(Eof())) .And. xFilial("SC6")==(cAliasSC6)->C6_FILIAL .And.;
		...
		If ( nPrcLista == 0 )
			nPrcLista := NoRound(nValMerc/(cAliasSC6)->C6_QTDRESE,TamSX3("C6_PRCVEN")[2])
		EndIf
		nAcresFin := A410Arred((cAliasSC6)->C6_PRCVEN*(cAliasSC5)->C5_ACRSFIN/100,"D2_PRCVEN")
		nValMerc  += A410Arred((cAliasSC6)->C6_QTDRESE*nAcresFin,"D2_TOTAL")		
		nDesconto := a410Arred(nPrcLista*(cAliasSC6)->C6_QTDRESE,"D2_DESCON")-nValMerc
		...
		MaFisAdd((cAliasSC6)->C6_PRODUTO	,;	// 1-Codigo do Produto ( Obrigatorio )
			...
			(cAliasSC6)->C6_QTDRESE			,;	// 3-Quantidade ( Obrigatorio )
		...
		MaFisAlt("IT_PESO",(cAliasSC6)->C6_QTDRESE*SB1->B1_PESO,Len(aItemPed))
		MaFisAlt("IT_PRCUNI",nPrcLista,Len(aItemPed))
		MaFisAlt("IT_VALMERC",nValMerc,Len(aItemPed))
...
IF !(aCabPed[1]$"DB")		//C5_TIPO
   ...
   nPrinLin := nInicio
	...
	nPrinLin += 30
	oReport:PrintText(cCepSA1+" "+;
						cMumSA1+" "+;
						cEstSA1,nPrinLin,760)
	nPrinLin += 30
...
nTotQtd += aItemPed[nItem][07]						//C6_QTDRESE
nTotVal += aItemPed[nItem][13]+nValImp				//C6_VALOR
nPesLiq	+= SB1->B1_PESO * aItemPed[nItem][07]		//C6_QTDRESE
nPesBru += SB1->B1_PESBRU * aItemPed[nItem][07]	//C6_QTDRESE
...
#IFDEF TOP
	If TcSrvType() <> "AS/400"
		...
		cQuery += "SC6.C6_TES,SC6.C6_CF,SC6.C6_QTDRESE,SC6.C6_PRUNIT,SC6.C6_VALDESC,"
...
@li,083 psay aItemPed[nItem][07] Picture PesqPictQt("C6_QTDRESE")	//C6_QTDRESE
...
//C6_QTDRESE C6_QTDEMP C6_QTDLIB C6_QTDENT
...
@ li,072 psay nTotQtd    Picture PesqPict("SC6","C6_QTDRESE",20)
