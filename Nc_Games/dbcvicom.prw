...
ฑฑบPrograma  ณDBCVICOM บ Autor ณ Alberto Kibino    บ Data ณ  29/10/12   บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
ฑฑบDescricao ณ RELATORIO PARA GERAR DBF PARA RELATึRIO de COMISSOES       บฑฑ
ฑฑบ          ณ Coordenador Vendas Internas                                 บฑฑ
...
MyNewSX6( "DBM_RCOMSV", 1, "N", "Percentual de comissใo Canal Regional", "Percentual de comissใo Canal Regional", "Percentual de comissใo Canal Regional", .F. )
MyNewSX6( "DBM_RCOMNO",  3, "N", "Grupo Coordenador Vendas internas","Grupo Key Account","Grupo Key Account", .F. )
...
cGrpCli := AllTrim(GetMv("DBM_GRPVIN"))
cGrpCl2 := AllTrim(GetMv("DBM_GRPVI2"))
...
_cQry+=" AND	ACA_GRPREP BETWEEN '" + cGrpCli + "' AND '" + cGrpCl2 + "'"  
...
cSqlDev += " F1_DTDIGIT, F2_EMISSAO, F2_CLIENTE, F2_LOJA, F2_VEND1, F1_TXMOEDA, F1_MOEDA, A3_NOME, A3_GRPREP, ACA_DESCRI, B1_XDESC, B1_PLATAF, B1_PUBLISH " + cAddField
...
cSqlDev += " AND A3_GRPREP BETWEEN '" + cGrpCli + "' AND '" + cGrpCl2 + "'"
...
PutSx1("DBM_CVICOM","01","Quarter Base"	   		,"Quarter Base"			,"Quarter Base"  		,"mv_ch1","N",01,0,1,"G","(mv_par01 < 5)",""   ,"","","mv_par01","","","","","","","","","","","","","","","","",{},{},{})
PutSx1("DBM_CVICOM","02","Ano Base"	   		,"Ano Base"			,"Ano Base"  		,"mv_ch2","C",04,0,1,"G","",""   ,"","","mv_par02","","","","","","","","","","","","","","","","",{},{},{})
